    ...
    <div>
      ...
      <Card>
        <div style={{marginBottom:16}}>
          ...
          <div style={{color:'#6b7280',fontSize:13}}>Jan 2026 ÃÂ¢ÃÂÃÂ Jul 2026 ÃÂÃÂ· All ISOs combined</div>
        </div>
      ...
      <div style={{marginBottom:20,background:'linear-gradient(135deg,#0f2040 0%,#1d4ed8 100%)',borderRadius:12,padding:'20px 28px',boxShadow:'0 4px 20px rgba(15,32,64,0.3)'}}>
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:16}}>
          <div>
            ...
            <div style={{color:'rgba(255,255,255,0.55)',fontSize:12,marginTop:4}}>Jan 2026 ÃÂ¢ÃÂÃÂ Jul 2026 ÃÂÃÂ· All ISOs combined</div>
          </div>
          <div>

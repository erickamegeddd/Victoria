...
const Dashboard = () => {
  ...
  const monthlyView = (
    <>
      ...
      <Row justify="center" style={{marginBottom:12}}><Col xs={24} md={14}><Card style={{textAlign:'center',background:'linear-gradient(135deg,#1d4ed8 0%,#2563eb 100%)',border:'none',borderRadius:14,boxShadow:'0 4px 20px rgba(29,78,216,0.35)'}}><div style={{fontSize:13,fontWeight:800,textTransform:'uppercase',letterSpacing:'0.6px',color:'rgba(255,255,255,0.8)',marginBottom:6}}>Total PayDiverse Net Income</div><div style={{fontSize:38,fontWeight:800,color:'#fff'}}>{'

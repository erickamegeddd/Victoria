  ...
  const monthlyView = (
    <>
      ...
      <Row gutter={16} style={{marginBottom:12}}>
        ...
        <Col span={6}><div style={{background:'#fef3c7',border:'1.5px solid #fbbf24',borderRadius:10,padding:'20px 24px',boxShadow:'0 1px 4px rgba(0,0,0,0.06)'}}><Statistic title="# of MIDs Added" value={new Set(residuals.filter(r=>!isAggregateMid(r.mid)&&newMerchantMids.has(r.mid)).map(r=>r.mid)).size} precision={0} valueStyle={{color:'#059669',fontWeight:700}}/></div></Col>
      </Row>
